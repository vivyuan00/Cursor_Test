...
| 目标编号 | 目标描述 | 衡量方式 |
|----------|----------|----------|
| G01 | 建立全链路转化漏斗数据模型，支持每日数据统计 | 漏斗日汇总表稳定产出，F01~F10各步数据准确 |
...
| 明细表 | 每行一个医助，列出加企微数、开口数、舌象上传数、开方数、支付数、确认数、支付转化率 | 表格，支持按列排序、搜索医助 |
